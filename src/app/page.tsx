...
export default function Home() {
  ...
  useEffect(() => {
    ...
    document.documentElement.lang = t === calculators ? 'ar' : 'en';
  }, [direction, t]);
  ...
  const features = [
    ...
    {
      icon: Calculator,
      title: t.whyUs.features.calculators.title,
      description: t.whyUs.features.calculators.description,
      color: "from-blue-500/20 to-cyan-500/20",
      border: "border-blue-500/30",
    },
    {
      icon: TrendingUp,
      title: t.whyUs.features.realtime.title,
      description: t.whyUs.features.realtime.description,
      color: "from-green-500/20 to-teal-500/20",
      border: "border-green-500/30",
    },
    {
      icon: Users,
      title: t.whyUs.features.academy.title,
      description: t.whyUs.features.academy.description,
  ...
  const stats = [
    ...
    { value: t.stats.toStart, label: "", icon: Zap },
  ...
  return (
    <div className="min-h-screen bg-background text-foreground" dir={direction}>
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-radial pointer-events-none" />
      ...
      <main className="relative">
        ...
        <section ref={homeRef} id="home" className="min-h-screen flex items-center justify-center pt-16 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              <span className="text-gradient-purple">{t.hero.title}</span>
              <br />
            ...
            >
              <Button
                ...
                className="bg-gradient-to-r from-primary to-accent-foreground hover:opacity-90 text-lg px-8"
              >
                {t.hero.cta.primary}
            ...
            >
              {stats.map((stat, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="p-6 rounded-xl glass-card border-primary/20 hover:border-primary/40 transition-all"
                  >
        ...
        <section className="py-20 px-4 bg-gradient-to-b from-transparent to-primary/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <Badge variant="outline" className="mb-4 bg-yellow-500/20 text-yellow-500 border-yellow-500/30">
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <Badge variant="outline" className="mb-4 bg-green-500/20 text-green-500 border-green-500/30">
        ...
        <section ref={calculatorsRef} id="calculators" className="py-20 px-4 bg-gradient-to-b from-primary/5 to-transparent">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <Badge variant="outline" className="mb-4 bg-cyan-500/20 text-cyan-500 border-cyan-500/30">
            ...
            <div className="grid lg:grid-cols-4 gap-6">
              ...
              <div className="lg:col-span-1">
                <Card className="glass-card border-primary/20 sticky top-20">
                  ...
                  <CardContent className="p-0">
                    <ScrollArea className="h-[600px]">
                      {Object.entries(calculatorCategories).map(([key, category]) => {
                        ...
                        const categoryLabel = t.calculators.categories[key as keyof typeof t.calculators.categories];
                        return (
                          <div key={key} className="mb-4">
                            <div className={`px-4 py-2 text-sm font-semibold bg-gradient-to-r from-primary/20 to-accent/20 text-foreground`}>
                              {typeof categoryLabel === 'string' ? categoryLabel : category.name}
                            </div>
              ...
              <div className="lg:col-span-3">
                ...
                {/* Quick Promo */}
                <Card className="mt-6 glass-card border-primary/20 bg-gradient-to-r from-primary/10 to-accent/10">
                  <CardContent className="flex flex-col sm:flex-row items-center justify-between gap-4 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold">{t.footer.readyToMaster}</p>
                        <p className="text-sm text-muted-foreground">
                          {t.footer.joinAcademyDesc}
                        </p>
                      </div>
                    </div>
                    <Button asChild className="bg-gradient-to-r from-primary to-accent-foreground shrink-0">
                      <a href="https://infinityalgoacademy.net/" target="_blank" rel="noopener noreferrer">
                        {t.footer.joinAcademy} <ExternalLink className="w-4 h-4 ml-2" />
                      </a>
                    </Button>
                  </CardContent>
                </Card>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="mt-8 flex flex-wrap gap-4">
                  <Button asChild className="bg-gradient-to-r from-primary to-accent-foreground">
                    <a href="https://infinityalgoacademy.net/" target="_blank" rel="noopener noreferrer">
                      {t.nav.academy} <ExternalLink className="w-4 h-4 ml-2" />
                    </a>
                  </Button>
                ...
                <Card className="glass-card border-primary/20">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {[
                        { phase: "Phase 2", feature: "Real-time Market Data", status: t.about.inProgress },
                        { phase: "Phase 3", feature: "Strategy Marketplace", status: t.about.planned },
                        { phase: "Phase 4", feature: "Broker Integration", status: t.about.planned },
                        { phase: "Phase 5", feature: "Enterprise Features", status: t.about.planned },
                      ].map((item, idx) => (
                        <div key={idx} className="flex items-center justify-between">
                          ...
                          <Badge
                            variant="outline"
                            className={
                              item.status === t.about.inProgress
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <Card className="glass-card border-primary/30 bg-gradient-to-r from-primary/10 to-accent/10 overflow-hidden">
